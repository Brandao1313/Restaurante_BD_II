...
$sql = "SELECT ped.id_pedido, ped.status, ped.data_criacao, ped.observacao, m.numero AS numero_mesa,
        ...
        ORDER BY m.numero ASC, ped.data_criacao ASC";
...
if ($pedidos) {
    ...
    $stmtItens = $pdo->prepare(
        "SELECT ip.id_item, ip.id_pedido, p.nome AS nome_produto, ip.quantidade, ip.preco_unitario, ip.observacao, ip.status
         FROM ItensPedido ip
